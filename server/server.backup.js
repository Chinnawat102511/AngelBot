...
// no-cache helper (ลด 304 สำหรับ endpoint ที่ต้องสดเสมอ)
...
function verifyChecksum(license) {
  ...
  // ถ้าต้องเข้มงวด: ตรวจ HMAC payload + secret ได้ที่นี่
...
/* แผงสรุป admin (ไม่ยิง request ออกจากโปรเซส) */
...
// latest (no-cache เพื่อลด 304 ระหว่าง dev)
...
// verify (GET/POST เหมือนกัน, no-cache)
